<template>
  <div class="three-feature">
    <div class="feature">
      <h2>WHO</h2>
      <em>Grayson Lorenz<br />Lorenz Wood Shop</em>
      <p>
        I am an application developer by day, wood worker... also by day, but on the weekends and evenings. I had always
        wanted a shop of my own, having grown up around folks who always worked with their hands. I made a few things
        around the house like a standing cabinet, a display for some games, and so on.
      </p>
    </div>
    <div class="feature">
      <h2>WHAT</h2>
      <em>A crafts person with many hats</em>
      <p>
    ...
    <div class="feature">
      <h2>WHEN</h2>
      <em>I'm not a master, but I'm not new</em>
      <p>
